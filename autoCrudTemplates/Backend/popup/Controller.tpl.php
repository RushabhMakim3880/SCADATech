        ...
        foreach ($data as $k=>&$row) {
            ...
            if (!$isDownload) {
                ...
                ********************************************/
                ...
                //edit button
                if (UserPermissionLib::userCanDo("{{MODULE_NAME}}", 'edit')) {
                    $dropdownItems[] = ['label' => 'Edit', 'class' => 'apiPopup text-warning', 'icon' => 'fa fa-edit', 'attributes' => "data-size='xl' data-title='{{ITEM_NAME}} Form' data-endpoint='" . ("{{MODULE_NAME}}/edit{{ITEM_NAME}}/" . setKey($primaryKey, "{{ITEM_NAME}}")) . "'"];
                }
                //delete button
