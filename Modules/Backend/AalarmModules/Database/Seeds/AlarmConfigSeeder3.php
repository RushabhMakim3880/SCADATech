...
class AlarmConfigSeeder3 extends Seeder
{
    public $priority = 102;
    ...
    public function run()
    {
        ...
        $data = [
            ['uiTagId' => '608', 'loloTheresold' => '-2', 'loTheresold' => '-1', 'hiTheresold' => '1', 'hihiTheresold' => '5', 'message' => 'Please start the main hydro motor']
        ];
