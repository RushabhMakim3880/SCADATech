...
class FeatureRegistrySeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $data[] = [
      ...
      'inputType' => 'text',
      'options' => null,
      'defaultValue' => 'configureYourEmail@mindstien.com',
      'isCustomizable' => 0,
      'isVisible' => 0,
      'isJsSide' => 0,
      'sortOrder' => 0,
    ...
    $data[] = [
      ...
      'inputType' => 'text',
      'options' => null,
      'defaultValue' => 'Mindstien Technologies Pvt Ltd',
      'isCustomizable' => 0,
      'isVisible' => 0,
      'isJsSide' => 0,
      'sortOrder' => 0,
    ...
    $data[] = [
      ...
      'inputType' => 'text',
      'options' => null,
      'defaultValue' => 'https://www.mindstien.com',
      'isCustomizable' => 0,
      'isVisible' => 0,
      'isJsSide' => 0,
      'sortOrder' => 0,
    ...
    $data[] = [
      ...
      'inputType' => 'text',
      'options' => null,
      'defaultValue' => 'www.mindstien.com',
      'isCustomizable' => 0,
      'isVisible' => 0,
      'isJsSide' => 0,
      'sortOrder' => 0,
