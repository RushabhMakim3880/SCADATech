...
class MachineMasterData10 extends Seeder
{
    public $priority = 23;
    ...
    public function run()
    {
        ...
        //fix tag mapping.
        $this->db->query("UPDATE `plcTagMaster` SET dataType = 'ns=4;s=|var|LicOS-PAC-MC512.Application.GVL.S_SYSTEM_FAULT' WHERE tagId=643");
        $this->db->query("UPDATE `plcTagMaster` SET dataType = 'ns=4;s=|var|LicOS-PAC-MC512.Application.GVL.T_YB_Voltage' WHERE tagId=620");
        $this->db->query("UPDATE `plcTagMaster` SET dataType = 'ns=4;s=|var|LicOS-PAC-MC512.Application.GVL.AL_PRINCHER_STRIAK' WHERE tagId=641");
