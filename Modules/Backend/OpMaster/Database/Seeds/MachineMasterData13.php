...
class MachineMasterData13 extends Seeder
{
    public $priority = 25;
    ...
    public function run()
    {
        ...
        $this->db->query("INSERT INTO `plcTagMaster` (`tagId`, `tenantId`, `serialNo`, `plcId`, `tagName`, `tagAddress`, `dataType`, `registerType`, `readWrite`, `scaleFactor`, `offset`, `unit`, `description`, `isActive`, `createdAt`, `updatedAt`, `createdBy`, `updatedBy`) VALUES
                            (648, 1, 648, 1, 'PRINCHER_DELAY_SET_TIMER', 'ns=4;s=|var|LicOS-PAC-MC512.Application.GVL.PRINCHER_DELAY_SET_TIMER', 'Int16', 'holding', 'readwrite', 1, 0, NULL, NULL, 1, '2025-09-16 09:16:35', '2025-09-16 09:16:35', 3, 3)
