...
<?php
// echo view('templates/' . $config->theme . '/layouts/viewOpener', ['title' => $pageTitle]) 
?>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-3 form-group mt-3">
                    ...
                    <input type="text" class="form-control locationPicker" id="newSampleName" name="newSampleName" placeholder="Enter New Sample Name" required>
                </div>
                ...
                <div class="col-md-3 form-group mt-3">
                    ...
                    <select class="form-control select2" id="simpleDropdownMultiple" name="simpleDropdownMultiple" multiple data-endpoint="/api/locationMaster/getLocations" data-selecttype="ajax">
                        <option value="0">Select Simple Dropdown Multi</option>
                    </select>
                </div>
                ...
                <!-- <div class="col-md-3 form-group mt-3"> -->
                <div class='col-md-3' data-dependent-on="category" data-dependent-value="two">
                ...
                <tbody>
                    <tr class="oneToManyRow">
                        <td>
                            ...
                            </select> <button type='button' class='btn btn-primary btn-sm addOneToManyRow e2t_ignore' tabindex="-1"><i class="fa fa-plus-circle"></i></button>
...
<?php
// echo view('templates/' . $config->theme . '/layouts/viewCloser')
?>