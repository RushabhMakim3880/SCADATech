...
class Captcha
{
    ...
    public function generate()
    {
        ...
        $possible_captcha_letters = '23456789ABCDEFGHJKLMNPQRSTUVWXYZ';
        $captcha_font = ROOTPATH . 'public/assets/fonts/MONOFONT.TTF';

        $random_captcha_dots = 100;
        $random_captcha_lines = 40;
        $captcha_text_color = "0x000000";
        $captcha_noise_color = "0x222222";
        ...
        // Save CAPTCHA text securely (e.g., in a database or encrypted JWT)
        $captchaKey = password_hash($captcha_code, PASSWORD_DEFAULT);

        // Send CAPTCHA Key as a response header
